...
<form>
  <div class="relative z-0 w-full mb-6 group">
      <input type="text" name="floating_id" id="floating_id" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div class="grid md:grid-cols-2 md:gap-6">
    ...
    <input id="floating_featured" type="checkbox" value=" " name="floating_featured" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
    <label for="floating_featured" class="ml-2 mt-5 text-sm text-gray-500 dark:text-gray-400 font-medium">Featured</label>
</div>
    </div>
    <div class="relative z-0 w-full mb-6 group">
